var World = {
    ...
    createOverlays: function createOverlaysFn() {
        ...
        this.targetCollectionResource = new AR.TargetCollectionResource('assets/nijntjeInDeSpeeltuin.wtc', {
        ...
        this.nijntjeTrackable = new AR.ImageTrackable(this.tracker, '*', {
            onImageRecognized: function(target) {
                 ...
                 */
                var nijntje = new AR.Model('assets/models/nijntje.wt3', {
                    scale: World.nijntjeSettings["nijntje"].scale,
                    rotate: {
                      z: 180,
                    },
                    onError: World.onError,
                ...
                this.addImageTargetCamDrawables(target, nijntje);
